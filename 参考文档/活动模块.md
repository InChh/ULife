...
<h2 id="tocS_EnrollmentRecord">EnrollmentRecord</h2>

<a id="schemaenrollmentrecord"></a>
<a id="schema_EnrollmentRecord"></a>
<a id="tocSenrollmentrecord"></a>
<a id="tocsenrollmentrecord"></a>
...
|名称|类型|必选|约束|中文名|说明|
|---|---|---|---|---|---|
|user_id|string|true|none|报名学生ID|none|
|user_name|string|true|none|姓名|none|
|student_id|string|true|none|学号|none|
|major|string|true|none|学院/专业|none|
|phone_number|string¦null|false|none|手机号|可选|
|activity_id|string|true|none|活动ID|none|
|enroll_time|string(date-time)|true|none|报名时间|none|
|attendance_status|integer|true|none|报名状态|1: 已报名, 2: 已取消报名|
