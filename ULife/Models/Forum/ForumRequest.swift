...
//
//    //发布新帖子
//    public func CreatePost(request: CreatePostRequest) -> PostDetail {
//        return PostDetail.mockDetail(for: "1")
//    }
//
//    //获取帖子列表
//    public func GetPostList(request: ListPostsRequest) -> ListPostsData{
//        return PostLite.getMockPostList(page: Int(request.page))
//    }
//
//    //获取帖子详情
//    public func GetPostDetail(id: String) -> PostDetail {
//        return PostDetail.mockDetail(for: id)
//    }
//
//    //发表评论
...
//
//    //举报帖子/评论
//    public func Report(request: CreateReportRequest) -> String {
//        return "1"
//    }
//
//    //删除评论
